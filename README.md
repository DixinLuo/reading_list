...
* _Jul. , 2026_ [](), ()
* _Jul. , 2026_ [](), ()
* _Jul. 6, 2026_ [Zero-to-CAD: Agentic Synthesis of Interpretable CAD Programs at Million-Scale Without Real Data](https://arxiv.org/pdf/2604.24479), (Bohan Zhang) 
* _Jun. 22, 2026_ [Meta-Harness: End-to-End Optimization of Model Harnesses](https://arxiv.org/pdf/2603.28052), (Sidan Zhu)
* _Jun. 16, 2026_ [Modeling the Density of Pixel-level Self-supervised Embeddings for Unsupervised Pathology Segmentation in Medical CT](https://openreview.net/forum?id=i7YnUW0uWg), (Xinran Niu)
* _Jun. 1, 2026_ [Shape-of-You: Fused Gromov-Wasserstein Optimal Transport for Semantic Correspondence in-the-Wild](https://arxiv.org/abs/2603.11618),(Jiaxin Zhang)
* _May. 25, 2026_ [FASTER: Rethinking Real-Time Flow VLAs](https://arxiv.org/abs/2603.19199), (Shihang Xia)
* _May. 11, 2026_ [Image Generators are Generalist Vision Learners](https://arxiv.org/abs/2604.20329), (Renchao Xie)
* _Apr. 27, 2026_ [Shoot First, Ask Questions Later? Building Rational Agents that Explore and Act Like People](https://openreview.net/forum?id=EQhUvWH78U), (Sidan Zhu)
* _Apr. 20, 2026_ [LeWorldModel: Stable End-to-End Joint-Embedding Predictive Architecture from Pixels](https://le-wm.github.io/), (Bohan Zhang)
...
* _Mar. 23, 2026_ [Inverse Virtual Try-On: Generating Multi-Category Product-Style Images from Clothed Individuals](https://arxiv.org/pdf/2505.21062), (Shihang Xia)
* _Mar. 16, 2026_ [VULCAN: Tool-Augmented Multi Agents for Iterative 3D Object Arrangement](https://arxiv.org/pdf/2512.22351), (Bohan Zhang)
* _Mar. 2, 2026_ [CountGD++: Generalized Prompting for Open-World Counting](https://arxiv.org/pdf/2512.23351), (Sidan Zhu)
* _Feb. 2, 2026_ [Recurrent Video Masked Autoencoders](https://arxiv.org/pdf/2512.13684), (Shihang Xia)
...
* _Oct. 15, 2025_ [SADA: Stability-guided Adaptive Diffusion Acceleration](https://arxiv.org/pdf/2507.17135), (Bohan Zhang)
* _Sep. 30, 2025_ [Zero-Shot Head Swapping in Real-World Scenarios](https://openaccess.thecvf.com/content/CVPR2025/papers/Kang_Zero-Shot_Head_Swapping_in_Real-World_Scenarios_CVPR_2025_paper.pdf), (Jiaxin Zhang)
* _Sep. 10, 2025_ [ControlFace: Harnessing Facial Parametric Control for Face Rigging](https://openaccess.thecvf.com/content/CVPR2025/papers/Jang_ControlFace_Harnessing_Facial_Parametric_Control_for_Face_Rigging_CVPR_2025_paper.pdf), (Tingting Yu)
